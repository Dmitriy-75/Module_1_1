...
print('\n"2nd program"')
print(f'9.99>9.98 and 1000 != 1000.1 is {9.99 > 9.98 and 1000 != 1000.1}')
...
print(f'2*2+2 = {2*2+2}')
print(f'2*(2+2) = {2*(2+2)}')
print(f'2*(2+2) = 2*(2+2) is {2*2+2 == 2*(2+2)}')
...
print('\n"4th program"')
print(f'Первая цифра в строке "123.456" после запятой = {int(float("123.456")*10) % 10}')
